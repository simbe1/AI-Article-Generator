...
// AJAX: Generate article
    ...
    public function render_admin_page() {
        ...
        <div class="wrap" style="max-width: 1200px;">
            ...
            <div style="background: #e8f5e9; border: 1px solid #4caf50; border-radius: 8px; padding: 15px 20px; margin-bottom: 20px;">
                <span style="color: #4caf50;"><i class="fas fa-robot"></i> AI Enabled</span>
            </div>
            <?php else: ?>
            <div style="background: #f9f9f9; border: 1px solid #ddd; border-radius: 8px; padding: 15px 20px; margin-bottom: 20px;">
                <span style="color: #999;"><i class="fas fa-robot"></i> Templates Only</span>
            </div>
            <?php endif; ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                <div style="background: #fff; padding: 30px; border-radius: 12px;">
                    ...
                    <button onclick="generateArticle()" class="button button-primary button-large" style="width: 100%; padding: 15px;">
                        Generate Article
                    </button>
                </div>
